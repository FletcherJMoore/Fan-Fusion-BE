...
namespace FanFusion_BE.Migrations
{
    ...
    [Migration("20241015231405_InitialMigrationFJM")]
    partial class InitialMigrationFJM
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FanFusion_BE.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("FanFusion_BE.Models.Chapter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FanFusion_BE.Models.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FanFusion_BE.Models.Story", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FanFusion_BE.Models.Tag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FanFusion_BE.Models.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FanFusion_BE.Models.Chapter", b =>
                {
                    b.HasOne("FanFusion_BE.Models.Story", "Story")
                        .WithMany("Chapters")
                        .HasForeignKey("StoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FanFusion_BE.Models.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("FanFusion_BE.Models.Comment", b =>
                {
                    b.HasOne("FanFusion_BE.Models.Chapter", "Chapter")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("FanFusion_BE.Models.Story", b =>
                {
                    b.HasOne("FanFusion_BE.Models.Category", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("StoryTag", b =>
                {
                    b.HasOne("FanFusion_BE.Models.Story", null)
                        .WithMany()
                        .HasForeignKey("StoriesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FanFusion_BE.Models.Tag", null)
                        .WithMany()
